from app.agent.nodes.understand_goal import conservative_goal
...
def test_fallback_router_directly_answers_general_coding_request() -> None:
    goal = conservative_goal("给我写一个 C 语言版本的接雨水")
    assert goal.decision == "RESPOND"
    assert goal.requires_enterprise_evidence is False
